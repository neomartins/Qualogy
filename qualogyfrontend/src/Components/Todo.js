...
class Todo extends Component{
    ...
    onSubmit () {
      let todo = {id: this.props.id, description: this.state.inputValue, state: this.props.checked};
      ...
      <FlatButton
		...
		return(
			<ListItem style={{width: '90%'}} rightIconButton={<div style={{display: 'flex'}}>
						 										...
						 										<IconButton tooltip='edit' tooltipPosition='bottom-left' onClick={this.handleOpen} >
						 											<EditIcon/>
						 										</IconButton>
						 										<Checkbox checked={this.props.checked} onCheck={this.onCheck}style={{marginTop:12}}/>
						 									</div>}>
